...
void encoder_read_task(void *pvParameters){
	...
	for(;;){
		...
		// Serial.println();
		// Serial.print((stepper.tick_speed[0]8)&0xff, HEX);
		// Serial.print(stepper.tick_speed[0]&0xff, HEX);
		// Serial.print(" ");
		// Serial.print((stepper.tick_speed[1]<<8)&0xff, HEX);
		// Serial.print(stepper.tick_speed[1]&0xff, HEX);
		// Serial.println();
		
		// Serial.print(stepper.tick_speed[0]);
		// Serial.print(" ");
		// Serial.print(stepper.tick_speed[1]);
		// Serial.println();

		// Serial.print(" "); Serial.println(numByte);
	}
